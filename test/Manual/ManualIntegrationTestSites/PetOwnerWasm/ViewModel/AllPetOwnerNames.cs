...
internal class AllPetOwnerNames(IEnumerable<PetOwnerName> names, IPetOwnerRepository petOwnerRepository, IViewUpdater<PetOwner> _petownerViewlUpdater)
{
    ...
    public Task AddFakePetOwner()
    {
        ...
        return _petownerViewlUpdater.Update(petOwner);
    }
}
