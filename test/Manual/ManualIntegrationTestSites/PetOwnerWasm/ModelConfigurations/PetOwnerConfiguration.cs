...
public class PetOwnerConfiguration(IDataUriConverter dataUriConverter) : IViewModelConfiguration<PetOwner>
{
    public ConfigurationBehavior ConfigurationBehavior { get; } = new()
    {
        ...
        TrackChanges = true,
        AutoGeneratedFunctionCaching = AutoGeneratedFunctionCaching.ByVersion("test 1.2")
    };
    ...
    public ModelMappingData ConfigureMapping(IModelMapper<PetOwner> modelMapper)
        => modelMapper
            ...
            .MapValue(po => po.Subscription).ToJsFunction("logVet").FromModule(new Uri("./modules/vet.js", UriKind.Relative))
            .MapValue(po => po.RegularVeterinarian).ToJsFunction("logVet").FromModule(new Uri("./modules/vet.js", UriKind.Relative))
