...
internal static class ExpectedGeneratedJsActionForOnlyOnceAtStart
{
    internal const string ExpectedJsCode =
        ...
        globalThis.vitraux.storedElements.getStoredElementsByQuerySelector(document, 'el9', 'p12');
        globalThis.vitraux.storedElements.getStoredElementByIdAsArray('el10', 'p13');

        const pc1 = (event) => {

            const p12 = globalThis.vitraux.storedElements.elements.p12;
            const p13 = globalThis.vitraux.storedElements.elements.p13;
        ...
        globalThis.vitraux.storedElements.getStoredElementByIdAsArray('el15', 'p14');
        globalThis.vitraux.storedElements.getStoredElementsByQuerySelector(document, 'el16', 'p15');

        const pc3 = (event) => {

            const p14 = globalThis.vitraux.storedElements.elements.p14;
